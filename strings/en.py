...
in_cart_format_string = "{quantity}kg in cart"
...
conversation_expired = "🕐  Hello, pay some attention to us, BFood :)\n" \
                       "If you want to order something, send a new /start command."
